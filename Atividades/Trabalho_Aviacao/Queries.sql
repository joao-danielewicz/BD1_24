...
SELECT
V.ID_VOO,
A1.LOCALIZACAO AS AEROPORTO_SAIDA,
A2.LOCALIZACAO AS AEROPORTO_ESCALA,
A3.LOCALIZACAO AS AEROPORTO_DESTINO
FROM
VOO AS V, AEROPORTO AS A1, AEROPORTO AS A2, AEROPORTO AS A3, ESCALA AS E
WHERE
